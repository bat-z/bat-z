...
⠀ ⠀ ⠀⠀⠀ ⠀ ⠀⠀ ⠀ ⠀ ⠀ ⠀ ⠀⠀ ⠀⠀⠀ ⠀ ⠀ ⠀ ⠀ ⠀⠀ ⠀⠀ ⠀ ⠀⠀ ⠀ ⠀ ⠀ ⠀ ⠀⠀ ⠀⠀ ⠀ 𐂂⠀-- ⠀[ABOUT ME](https://favoritecharactersz.straw.page)
...
⠀ ⠀   ⠀ invisible disabled & mental illness⠀
...
⠀⠀⠀⠀ ⠀ ⠀-- I don't comment on ata except with ⠀⠀ ⠀⠀some close friends. I mostly use VPN for safety lol. And if someone impersonating me made a comment on ata that isn't my friend, that is NOT me. Same with ppl copying my skins. I'm not worried of ppl copying my skins. I just worry about them using it in weird ways.
...
mains: Halbarry, Harvey Dent/Bruce Wayne, Boostle, Hal/Oliver, Captain cold/heatwave, Captain cold/Flash CW, Barry allen/Oliver queen CW, more
...
idk: Sinhal[use to dislike this ship, but kinda starting like them.], Guy/Arkillo[same with this one], Superman/Lex luthor[not a huge fan, bu its alr], Selina/Talia, Superman/Lobo, Lex luthor/Braniac, & more
